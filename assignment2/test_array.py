...
def test_add_1d():
    ...
    int_result1 = int_array1 + int_array2 # Array + Array
    int_result2 = int_array1 + int_scalar # Array + Scalar
    int_result3 = int_scalar + int_array1 # Scalar + Array | __radd__
    ...
    float_array1 = Array((7,), 1.5, -3.0, 5.5, -1.3, 2.6)
    float_array2 = Array((7,), -2.3, -2.1, 3.0, -4.8, 5.2)
    float_scalar = 3.5
...
def test_sub_1d():
    ...
    # Test correct subtraction of 1 of each type of array, int float and bool.
    
    # Test __rsub__ function of reversed operators.
    
    # Test faulty shapes of arrays.
...
def test_mul_1d():
    ...
    # Test correct multiplication of 1 of each type of array, int float and bool.
    
    # Test __rmul__ function of reversed operators.
...
def test_eq_1d():
    ...
    # Test equality and unequality of arrays with == != operators.
...
def test_same_1d():
    ...
    # Test 2 separate instances of same shape arrays.
    
    # Test 2 instances of faulty shapes.
...
def test_smallest_1d():
    ...
    # Test 2 different arrays of different shapes.
